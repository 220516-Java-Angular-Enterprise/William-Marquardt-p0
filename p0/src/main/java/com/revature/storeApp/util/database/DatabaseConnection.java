package com.revature.storeApp.util.database;
...
//TODO: review lecture where this was created

/* Notice that this class is a Singleton design pattern. This is because
* we only need to cohnect to the database once*/
